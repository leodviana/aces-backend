...
namespace GtecIt.Controllers
{
    ...
    public class PessoaController : Controller
    {
        ...
        public PessoaController(IUnitOfWork uoW)
        {
            _uoW = uoW;
        ...
        public ActionResult Create(PessoaCreateViewModel model, FormCollection form)
        {
            ...
            {
                return RedirectToAction("Edit","Pessoa", new { codigo = idPessoa });
            }
            if (model.origem.Equals("Pessoa"))
            {
                ...
                return RedirectToAction("Edit", "Cliente", new { codigo = idCliente, pagina_origem = "Pessoa" });
            }
            if (model.origem.Equals("vendedor"))
            {
                ...
                //  _clienteApp.AddReturnId(new Cliente { Id_grlbasico = idPessoa, Ativo = "S" });
                // return RedirectToAction("Create", "Orcamento", new OrcamentoCreateViewModel { id_grlcliente = idCliente });
                return RedirectToAction("Edit", "Dentista", new { codigo = idDentista, pagina_origem = "vendedor" });
            }
            ...
            if (model.origem.Equals("cliente"))
            {
                // ferificar com o duan  porque nao aceita assim 
                Cliente dentista = new Cliente { Id_grlbasico = idPessoa, Ativo = "S" };
                //DentistaEditViewModel model_dentista = new DentistaEditViewModel { Id_grlbasico = idPessoa, Ativo = "S" };
                //var dentista = Mapper.Map<Dentista>(model_dentista);
                _uoW.Clientes.Salvar(dentista);
                _uoW.Complete();
                var idDentista = dentista.id_Grlcliente;

                
                return RedirectToAction("Edit", "Cliente", new { codigo = idDentista, pagina_origem = "cliente" });
            }
            ...
            if (model.origem.Equals("Orcamento"))
            {
                // ferificar com o duan  porque nao aceita assim 
                ...
                //  _clienteApp.AddReturnId(new Cliente { Id_grlbasico = idPessoa, Ativo = "S" });
                // return RedirectToAction("Create", "Orcamento", new OrcamentoCreateViewModel { id_grlcliente = idCliente });
                return RedirectToAction("Edit", "Cliente", new { codigo = idCliente, pagina_origem = "Orcamento" });
            }
