...
{
    public class CefalometriaItemRepositorio :Repositorio<CefalometriaItem>, ICefalometriaItemRepositorio
    {
        public CefalometriaItemRepositorio(DbContext context)
            : base(context)
        {
        }
